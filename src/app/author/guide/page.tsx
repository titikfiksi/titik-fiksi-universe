...
import { ArrowLeft, BookOpen, Edit3, Lock, CalendarClock, MessageSquare, HelpCircle, Image as ImageIcon, CheckCircle2 } from "lucide-react";
...
export default function AuthorGuidePage() {
  return (
    <div className="max-w-4xl mx-auto space-y-8 animate-fade-in-up pb-20">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        <div>
          <h1 className="text-3xl font-black text-gray-900 flex items-center gap-3">
            <HelpCircle className="text-indigo-600" size={32}/> Panduan <span className="text-indigo-600">Penulis</span>
          </h1>
          <p className="text-gray-500 font-bold mt-1">Pelajari cara memaksimalkan fitur ruang kerjamu.</p>
        </div>
      ...
      <div className="bg-white p-8 md:p-12 rounded-[2.5rem] border border-gray-200 shadow-sm space-y-12">
        
        {/* PENGANTAR */}
        <div className="bg-indigo-50 border border-indigo-100 p-6 md:p-8 rounded-2xl">
          <h2 className="text-xl font-black text-indigo-900 mb-3">Selamat Datang di Titik Fiksi Universe! 🚀</h2>
        ...
        <div className="space-y-4">
          ...
          <ul className="space-y-4 text-gray-600 font-medium ml-2 border-l-2 border-blue-100 pl-4">
            ...
            <li className="bg-blue-50/50 p-4 rounded-xl border border-blue-100">
              <strong className="text-blue-900 flex items-center gap-2 mb-2"><ImageIcon size={16}/> Cara Memasang Poster / Sampul Novel:</strong>
        ...
        <div className="space-y-4">
          ...
          <ul className="space-y-3 text-gray-600 font-medium ml-2 border-l-2 border-emerald-100 pl-4">
            ...
            <li><strong className="text-emerald-700 flex items-center gap-1.5 mb-1">Penyimpanan Otomatis (Auto-Save) <CheckCircle2 size={16} className="text-emerald-500"/> :</strong> Jangan takut mati lampu atau tab tertutup! Setiap ketikan Anda akan otomatis tersimpan di dalam <i>browser</i>. Buka kembali halamannya, dan draf terakhir Anda akan otomatis dipulihkan.</li>
          </ul>
        </div>
        ...
        <div className="space-y-4">
          <div className="flex items-center gap-3 pb-2 border-b border-gray-100">
            <div className="w-10 h-10 bg-amber-100 text-amber-500 rounded-xl flex items-center justify-center"><Lock size={20}/></div>
        ...
        <div className="space-y-4">
          <div className="flex items-center gap-3 pb-2 border-b border-gray-100">
            <div className="w-10 h-10 bg-purple-100 text-purple-600 rounded-xl flex items-center justify-center"><CalendarClock size={20}/></div>
            <h3 className="text-lg font-black text-gray-900">4. Fitur Jadwal Tayang</h3>
          </div>
        ...
        <div className="space-y-4">
          <div className="flex items-center gap-3 pb-2 border-b border-gray-100">
            <div className="w-10 h-10 bg-pink-100 text-pink-500 rounded-xl flex items-center justify-center"><MessageSquare size={20}/></div>
            <h3 className="text-lg font-black text-gray-900">5. Membalas Komentar Pembaca</h3>
          </div>
